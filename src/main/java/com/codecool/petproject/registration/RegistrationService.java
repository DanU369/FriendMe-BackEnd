...
import com.codecool.petproject.user.model.UserRole;
import com.codecool.petproject.user.service.UserService;
import com.codecool.petproject.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request){
        ...
        boolean isValidUser= emailValidator.test(request.getUsername());
        if(!isValidEmail){
